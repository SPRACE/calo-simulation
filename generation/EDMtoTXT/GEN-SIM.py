...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/SingleElectronFlatE20To100_pythia8_cfi.py nevts:10'),
...
process.generator = cms.EDFilter("Pythia8EGun",
    PGunParameters = cms.PSet(
        ...
        MaxE = cms.double(50.000001),
        MaxEta = cms.double(1e-11),
        MaxPhi = cms.double(1e-11),
        MinE = cms.double(49.999999),
        MinEta = cms.double(-1e-11),
        MinPhi = cms.double(-1e-11),
